...
function! neofinder#palette(...) abort
  ...
  if query ==# 'help'
    return neofinder#help()
  elseif query ==# 'about'
    return neofinder#about()
  endif
  ...
  let sources = [
        ...
        \ ['About           :fa   version & help',               'call',   'neofinder#about()'],
        \ ]
...
" ---------------------------------------------------------------------------
" ---------------------------------------------------------------------------
" :Neo about -- splash screen with version, ASCII art, and help link
" ---------------------------------------------------------------------------
function! neofinder#about() abort
  let ver = 'v2.0.0'
  let lines = [
        \ '',
        \ '',
        ...
        \ '                    ' . ver,
        \ '',
        \ '   File browser, command runner and editor toolkit',
        \ '   for Vim / Neovim',
        \ '',
        \ '   ------------------------------------------',
        \ '',
        ...
        \ '',
        \ '   :Neo           open palette',
        \ '   :Neo help      quick reference',
        \ '   :Neo about     this screen',
        \ '',
        \ '   Help & docs:',
        \ '   https://mefardales.github.io/neofinder/',
        \ '',
        \ '   Source:',
        \ '   https://github.com/mefardales/neofinder',
        \ '',
        \ '   License: MIT',
        \ '',
        \ ]

  call neofinder#core#run('about', lines, '')
endfunction
